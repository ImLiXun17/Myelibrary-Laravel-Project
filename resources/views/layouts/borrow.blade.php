            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                <form action="{{ route('borrow') }}" method="GET">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card-header ">
                                    ...
                                    <p class="card-category">Here is ythe list of borrows</p>
                                </div>
                                    ...
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                          @foreach($borrows as $borrow)
                                            <tr>
                                                <td>{{ $borrow->student->student_name  ?? 'N/A'}}</td>
                                                <td>{{ $borrow->book->book_name }}</td>
                                                <td>{{ $borrow->college->college_name }}</td>
                                                <td>{{ $borrow->time_borrow}}</td>
                                                <td>{{ $borrow->time_return}}</td>
                                                <td>{{ $borrow->fines}}</td>
                                                <td>{{ $borrow->action}}</td>
                                                <td>
                                                    <a href="{{ route('borrow-edit', ['borrow_id' => $borrow->borrow_id]) }}">
                                                    <button type="submit" class ="btn btn-warning btn-fill pull-right">Edit</button>
                                                    </a>
                                                </td>
                                                <td>
                                                <form action="{{ route('borrow-delete', ['borrow_id' => $borrow->borrow_id]) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                    ...
                    {{ $borrows->links('vendor.pagination.default') }}
                </div>
            </div>
            <footer class="footer">
                <div class="container-fluid">
