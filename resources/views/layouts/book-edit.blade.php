...
<head>
    ...
    <title>Edit Book Section - E-Library</title>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                <form method="POST" action="{{ route('book.update', ['bid' => $book->bid]) }}">
                                    @csrf
                                    @method('PUT')
                                        <div class="row">
                                            <div class="col-md-4 pr-1">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="book_isbn"value="{{ $book->book_isbn }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="">Book Available</label>
                                            ...
                                            <div class="col-md-6 pr-1">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="year_published"value="{{ $book->year_published }}">
                                                </div>
                                            </div>
                                        </div>
...
document.getElementById("save-button").addEventListener("click", function() {
  alert("Book upadate successfully!");
});
</script>
</html>
