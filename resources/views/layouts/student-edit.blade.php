                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{ route('student.update', ['sid' => $student->sid]) }}">
                                    @csrf
                                    @method('PUT')
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 pl-1">
                                                <div class="form-group">
                                                    ...
                                                    <input type="email" class="form-control" name ="corporate_email"value="{{ $student->corporate_email }}">
                                                </div>
                                            </div>
                                            <div class="col-md-4 pl-1">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="college_id">
                                                    ...
                                                    @foreach($college as $collegeItem)
                                                        @if($collegeItem->id == $student->college_id)
                                                            <option value="{{ $collegeItem->id }}" selected>
